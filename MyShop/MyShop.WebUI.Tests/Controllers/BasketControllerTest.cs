...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "sandersk1991@gmail.com", ZipCode = "76201" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("sandersk1991@gmail.com", "Forms"), null);
